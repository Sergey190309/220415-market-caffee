...
# @pytest.mark.active
# def test_contents_post(
#         test_client, url_component_kinds, content_api_resp):
#     pass
    ...
    #   url_component_kinds, json=_components_kinds_same_id_json)
    ...
    #     resp = test_client.post(
    #   url_component_kinds, json=_components_kinds_bad_json)
    #     # print(resp.status_code)
    #     assert resp.status_code == 400
