...
describe('EditorContextMenu testing', () => {
  ...
  describe('component actions', () => {
    test('save button enabled', async () => {
      ...
      const saveButton = screen.getByRole('button', { name: '2ndLavel.save' })
    ...
    test('back button clicked actions', async () => {
      ...
      expect(screen.queryByTestId('Popup')).not.toBe(null)
      const backButton = screen.getByRole('button', { name: '2ndLavel.back' })
    ...
    test('cancel button clicked actions', async () => {
      ...
      expect(screen.queryByTestId('Popup')).not.toBe(null)
      const cancelButton = screen.getByRole('button', { name: '2ndLavel.cancel' })
